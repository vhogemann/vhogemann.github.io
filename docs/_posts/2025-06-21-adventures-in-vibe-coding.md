...
![Visualization of a log flow, using the default dark theme](/assets/adventures-in-vibe-coding/default.png)
...
Light Theme
![Visualization of a log flow, using the Light theme](/assets/adventures-in-vibe-coding/light.png)
...
![Visualization of a log flow, using the Vaporwave theme](/assets/adventures-in-vibe-coding/vaporwave.png)


Unicorn Theme (bright and fluffy) - No notes, perfect!
![Visualization of a log flow, using the Unicorn theme](/assets/adventures-in-vibe-coding/unicorn.png)
...
![Visualization of a log flow, using the Hotdog theme](/assets/adventures-in-vibe-coding/hotdog.png)
...
![Visualization of a log flow, using the Gameboy theme](/assets/adventures-in-vibe-coding/gameboy.png)

Autumn Theme
![Visualization of a log flow, using the Autumn theme](/assets/adventures-in-vibe-coding/autumn.png)

Cyberpunk Theme
![Visualization of a log flow, using the Cyberpunk theme](/assets/adventures-in-vibe-coding/cyberpunk.png)

Matrix Theme
![Visualization of a log flow, using the Matrix theme](/assets/adventures-in-vibe-coding/matrix.png)

Oceanic Theme
![Visualization of a log flow, using the Oceanic theme](/assets/adventures-in-vibe-coding/oceanic.png)

Solarized Theme
![Visualization of a log flow, using the Solarized theme](/assets/adventures-in-vibe-coding/solarized.png)